            ...
            >
                <div className='pb-8'>
                    ...
                    <p className='text-gray-400 py-4'>
                        // Submit the form below or shoot me an email - myemail@example.com
                    </p>
                </div>
                ...
                <button
                    type='submit'
                    className='text-white border border-purple-500 bg-purple-600/20 hover:bg-purple-600 hover:border-purple-600 px-4 py-3 my-8 mx-auto flex items-center rounded-md font-bold text-lg transition-all duration-300 hover:shadow-[0_0_20px_rgba(147,51,234,0.5)]'
                >
                    Let's Collaborate
                </button>
            </motion.form>
